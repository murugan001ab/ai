...
/**
 * Reusable modal shell — handles backdrop, header, footer, error display.
 * Drop form fields as children.
 */
export default function ModalShell({
  ...
  return (
    <div className='fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm'>
      <div
        className={`bg-slate-900 border border-slate-700 rounded-2xl w-full ${maxWidth} mx-4 shadow-2xl`}
      >
        {/* Header */}
